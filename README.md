...
<p align="center">
    ...
    <h3 align="center"><a href="https://learnwithsumit.com/courses/think-in-a-redux-way/8-12-task-advanced-todo-application-with-rtk-query">Assignment 8 - Advanced Todo Application with RTK Query</a></h3>
</p>
...
2. Clone this repository -
    ```sh
    git clone https://github.com/Learn-with-Sumit/assignment-8---advanced-todo-application-with-rtk-query-programmertowheed.git
    ```
3. Go to the cloned project directory
    ```sh
    cd assignment-8---advanced-todo-application-with-rtk-query-programmertowheed
    ```
